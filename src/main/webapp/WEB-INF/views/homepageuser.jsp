...
body {
	...
	background-image:
		url('https://img.freepik.com/free-photo/abstract-luxury-gradient-blue-background-smooth-dark-blue-with-black-vignette-studio-banner_1258-63490.jpg');
}
...
<body>
	<nav>
			...
			<div class="search-bar">
				<form action="/search" method="get">
					...
					<button type="submit" class="search-button">
						<img
							src="https://www.shutterstock.com/image-vector/magnify-icon-vector-eps10-260nw-1220721013.jpg"
							alt="Search" />
					</button>
				</form>
			</div>
		...
		<ul>
			...
			<!-- My Account Dropdown -->
			<li class="account-dropdown"><a href="#">My Account</a>
				<ul class="dropdown-content">
					<li><a href="${pageContext.request.contextPath}/wishlist/view">Wishlist</a></li>
					<li><a href="${pageContext.request.contextPath}/cart/view">Cart
							Items</a></li>
					<li><a
						href="${pageContext.request.contextPath}/order/displayOrders">Orders</a></li>
					<li><a
	...
	<section>
		<div class="center-button">
			<button class="explore-button"
				onclick="window.location.href='${pageContext.request.contextPath}/products/display1'">Explore
				All Products</button>
		</div>
	</section>
	...
	<section>
		...
		<div class="products-row">
			...
			<div class="product">
				<a
					href="${pageContext.request.contextPath}/products/<%= product.getProduct_id() %>">
					<img
					src="data:image/jpeg;base64,<%=product.getBase64ProductImage()%>"
					alt="<%=product.getProduct_name()%>">
				</a>
				<p><%=product.getProduct_name()%>
					&#8377;<%=product.getFinal_price()%></p>
			</div>
			<%
			if ((i + 1) % 3 == 0) {
			%>
			<div class="explore-button"
				onclick="window.location.href='${pageContext.request.contextPath}/explore-new-trends'">Explore
				All</div>
			<%
			}
			}
	...
	<section>
		...
		<div class="products-row">
			...
			%>
			<div class="explore-button"
				onclick="window.location.href='${pageContext.request.contextPath}/explore-new-arrivals'">Explore
				All</div>
			<%
			}
			}
	...
	<section>
		...
		<div class="products-row">
			...
			%>
			<div class="explore-button"
				onclick="window.location.href='${pageContext.request.contextPath}/explore-discount-products'">Explore
				All</div>
			<%
			}
			}
	...
	<section>
		...
		<div class="products-row">
			...
			%>
			<div class="explore-button"
				onclick="window.location.href='${pageContext.request.contextPath}/explore-best-brands'">Explore
				All</div>
			<%
			}
			}
	...
	<section>
		...
		<div class="products-row">
			...
			<div class="product">
				<a
					href="<%=request.getContextPath()%>/products/category/<%=category.getCategory_id()%>">
					<img
					src="data:image/jpeg;base64,<%=category.getBase64CategoryImage()%>"
			...
			%>
			<div class="explore-button"
				onclick="window.location.href='<%=request.getContextPath()%>/explore-all-categories'">Explore
				All</div>
			<%
			}
			}
